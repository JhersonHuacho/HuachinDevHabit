...
namespace HuachinDevHabit.Api.Migrations.Application
{
    ...
    [Migration("20250521001236_Add_Entries")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HuachinDevHabit.Api.Entities.Entry", b =>
                {
            ...
            modelBuilder.Entity("HuachinDevHabit.Api.Entities.GitHubAccessToken", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("HuachinDevHabit.Api.Entities.Habit", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("HuachinDevHabit.Api.Entities.HabitTag", b =>
                {
                    b.Property<string>("HabitId")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("HuachinDevHabit.Api.Entities.Tag", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("HuachinDevHabit.Api.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("HuachinDevHabit.Api.Entities.Entry", b =>
                {
                    b.HasOne("HuachinDevHabit.Api.Entities.Habit", "Habit")
                        .WithMany()
                    ...
                    b.HasOne("HuachinDevHabit.Api.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HuachinDevHabit.Api.Entities.GitHubAccessToken", b =>
                {
                    b.HasOne("HuachinDevHabit.Api.Entities.User", null)
                        .WithOne()
                        .HasForeignKey("HuachinDevHabit.Api.Entities.GitHubAccessToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("HuachinDevHabit.Api.Entities.Habit", b =>
                {
                    ...
                    b.OwnsOne("HuachinDevHabit.Api.Entities.Frequency", "Frequency", b1 =>
                        {
                    ...
                    b.OwnsOne("HuachinDevHabit.Api.Entities.Milestone", "Milestone", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("HuachinDevHabit.Api.Entities.Target", "Target", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("HuachinDevHabit.Api.Entities.HabitTag", b =>
                {
                    b.HasOne("HuachinDevHabit.Api.Entities.Habit", null)
                        .WithMany("HabitTags")
                        .HasForeignKey("HabitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("HuachinDevHabit.Api.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
